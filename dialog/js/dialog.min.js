/* Dialog component for jQuery ( AMD Module ) | MIT Licenses | 2013-10-27 */
...
b.length&&(b.hide(),u.append(b)),e.append(h),p=h.find("a.dg_btn_yes"),s=h.find("a.dg_btn_no"));h.css({width:a.width,height:a.height});if(d)p.on("click.dialog",function(b){!1!==a.yesFn.call(e[0],b)&&f.close(a);b.preventDefault()});k&&(c=function(b){!1!==a.noFn.call(e[0],b)&&f.close(a);this.href&&b.preventDefault()},s.on("click.dialog",c));t=h.find("a.dg_btn_close");a.lock?t.hide():(t.show(),t.on("click.dialog",c))}},resize:function(a){var b=a.data.o;a=m.width()/2;var d=m.height()/2,k={};n&&e[0].style.removeExpression("top");
...
document.documentElement.clientHeight/2)+'+"px"',e[0].style.setExpression("top",a))},bindDrag:function(a){a.drag&&(a=a.dragHandle||e.find("div.dg_header"),a.length&&a.is(":visible")&&(v=new $.ui.Drag(e,{handle:a})))},patterns:function(a,b){var d=e[0].style,k=d.top,g=d.left,f="from",c="to",h="Out",n="fixed"===d.position;e.offset();var d=parseInt(k),p=parseInt(g),q=e.outerWidth(),l=e.outerHeight(),r={},k={opacity:"",width:"",height:"",overflow:"",top:k,left:g};b&&(f="to",c="from",h="In",k.display="none");
switch(a){case "fade":r[f]={opacity:"0",top:d-50+"px"};r[c]={opacity:"1",top:d+"px"};r.duration=200;break;case "slide":g=n?0:m.scrollTop();r[f]={top:g-l/2+"px"};r[c]={top:d+"px"};r.easing="ease"+h+"Strong";break;case "zoom":r[f]={opacity:"0",left:p+q/2+"px",top:d+l/2+"px",width:"0px",height:"0px"},r[c]={opacity:"1",left:p+"px",top:d+"px",width:q+"px",height:l+"px"},r.duration=200,r.easing="ease"+h}return[r,k]},open:function(a){var b=a.effects,d=function(b){return function(){e.css(b);f.bindExpression(a);
...
200,function(){c.css({display:"none",opacity:b})})}}):(c.hide(),e.hide());v&&(v.destroy(),v=null);h&&(p.off("click.dialog"),s.off("click.dialog"),t.off("click.dialog"));a.elem&&a.elem.hide();m.off("resize.dialog");y.off("keyup.dialog");a.overlayClose&&c.off("click.dialog");a.target.trigger("likeclose")},init:function(a,b){e&&(e.length&&e.is(":visible"))&&(c.hide(),e.hide());f.createOverlay(a.zIndex);f.createDialogBox(a.zIndex+1,a.overlay);f.createDialogContent(a);if(a.overlay){c.css({visibility:"hidden",
...
$(x);y=$(q);u=$(q.body);d.elem&&(d.elem=$(d.elem).eq(0),d.elem.length||(d.elem=null));d.dragHandle&&(d.dragHandle=$(d.dragHandle).eq(0),d.dragHandle.length||(d.dragHandle=null));a.on(d.trigger+".dialog",function(){f.init(d)});d.target=a;this.__o__=d}};z.prototype={destroy:function(){if(this.__o__){var a=this.__o__;e.is(":visible")&&this.close();c.remove();e.remove();a.target.off(a.trigger+".dialog likeopen likeclose");delete this.__o__}},on:function(a,b){if(this.__o__){var d=this;d.__o__.target.on("like"+
a,function(c){c.type=a;c.target=e[0];b.call(d,c);c.stopPropagation()})}return this},un:function(a){this.__o__&&this.__o__.target.off("like"+a);return this},close:function(){this.__o__&&f.close(this.__o__);return this}};$.ui||($.ui={});$.ui.Dialog=z});
