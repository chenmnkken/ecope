/* Dialog component for jQuery ( AMD Module ) | MIT Licenses | 2013-11-16 */
define(["../../drag/js/drag"],function(){$.easing.easeIn=function(a){return a*a};$.easing.easeOut=function(a){return(2-a)*a};$.easing.easeInStrong=function(a){return a*a*a*a};$.easing.easeOutStrong=function(a){return 1- --a*a*a*a};var A={autoClose:null,content:"Hello world : )",title:null,yesText:"\u786e\u5b9a",noText:"\u53d6\u6d88",yesFn:null,noFn:null,width:"320px",height:"auto",top:null,left:null,trigger:"click",overlay:!0,overlayClose:!1,fixed:!0,lock:!1,effects:null,zIndex:9999,drag:!0,topWindow:!1,
...
200,function(){c.css({display:"none",opacity:b})})}}):(c.hide(),e.hide());v&&(v.destroy(),v=null);h&&(p.off("click.dialog"),s.off("click.dialog"),u.off("click.dialog"));a.elem&&a.elem.hide();m.off("resize.dialog");y.off("keyup.dialog");a.overlayClose&&c.off("click.dialog");a.target.trigger("likeclose")},init:function(a,b){e&&(e.length&&e.is(":visible"))&&(c.hide(),e.hide());f.createOverlay(a.zIndex);f.createDialogBox(a.zIndex+1,a.overlay);f.createDialogContent(a);if(a.overlay){c.css({visibility:"hidden",
